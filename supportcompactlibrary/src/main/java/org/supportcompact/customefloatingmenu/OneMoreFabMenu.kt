...
class OneMoreFabMenu @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val initialFabRightMargin = 5
    ...
    private var mainButtonExpandedColor = ContextCompat.getColor(context, R.color.white)
    ...
    private var expandedBackgroundDrawable: Drawable? = null
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        //    background = expandedBackgroundDrawable
            ...
            background = null
            initialFab.backgroundTintList = ColorStateList.valueOf(colorMainButton)
    ...
    private fun initializeUI(attrs: AttributeSet? = null) {
        ...
        val mainButtonExpandedColor = attributes.getResourceId(R.styleable.OneMoreFabMenu_color_main_button_expanded, R.color.omfm_default_color)
        this.mainButtonExpandedColor = ContextCompat.getColor(context, mainButtonExpandedColor)
        ...
        this.secondaryFabSize = attributes.getInt(R.styleable.OneMoreFabMenu_size_secondary_buttons, FloatingActionButton.SIZE_NORMAL)
        ...
        val expandedBackgroundDrawable = attributes.getResourceId(R.styleable.OneMoreFabMenu_expanded_drawable, -1)
        this.expandedBackgroundDrawable = if(expandedBackgroundDrawable != -1) ContextCompat.getDrawable(context, expandedBackgroundDrawable) else null
    ...
    private fun calculateOptionsButton(initialFabTop: Int, horizontalCenter: Int) {
        val labelsOffset = (maxButtonWidth / 4)
        ...
        for(i in 0..(childCount-1)) {
            ...
            if(view.id != initialFab.id && view.id != mainLabelId && view.visibility != View.GONE) {
                ...
                val extra = if(i == 0) -15 else 30
                val childY = if(state == Direction.EXPANDED) nextY - view.measuredHeight + extra else nextY
