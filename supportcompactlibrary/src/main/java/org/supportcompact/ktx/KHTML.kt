...
fun TextView.makeLinksItalic(links: Array<String>, clickableSpans: Array<ClickableSpan>) {
    ...
    for (i in links.indices) {
        ...
        spannableString.setSpan(StyleSpan(ITALIC), startIndexOfLink, startIndexOfLink + link.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
    }
