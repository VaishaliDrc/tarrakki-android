...
import org.supportcompact.ktx.KBitmapKt;
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private boolean crop() throws IOException {
        ...
        if (shouldCrop) {
            ...
            saveImage(KBitmapKt.scaleBitmap(mViewBitmap, cropOffsetX, cropOffsetY, mCroppedImageWidth, mCroppedImageHeight));
