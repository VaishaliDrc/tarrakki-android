...
class BankMandateVM : FragmentViewModel() {
    ...
    fun getISIPMandateData(mandateId: String?): MutableLiveData<ApiResponse> {
        showProgress()
        val apiResponse = MutableLiveData<ApiResponse>()
        subscribeToSingle(ApiClient.getHeaderClient().create(WebserviceBuilder::class.java).getISIPMandateData(mandateId), object : SingleCallback1<ApiResponse> {
