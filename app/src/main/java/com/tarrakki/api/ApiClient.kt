...
object ApiClient {
    ...
    private const val BASE_URL = "https://3eb48d8e.ngrok.io/api/v3/"
    const val IMAGE_BASE_URL = "https://3eb48d8e.ngrok.io"
    const val BANK_REDIRECT_URL = "https://3eb48d8e.ngrok.io/api/v3/transactions/payment-status/"
