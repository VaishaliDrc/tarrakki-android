...
object ApiClient {
    ...
    private const val BASE_URL = "https://76eb30fe.ngrok.io/api/v3/"
    const val IMAGE_BASE_URL = "https://76eb30fe.ngrok.io"
    const val BANK_REDIRECT_URL = "https://76eb30fe.ngrok.io/api/v3/transactions/payment-status/"
