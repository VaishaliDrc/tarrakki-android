...
object ApiClient {
    ...
    /*private const val BASE_URL = "https://93eeb3ad.ngrok.io/api/v3/"
    const val IMAGE_BASE_URL = "https://93eeb3ad.ngrok.io"
    const val BANK_REDIRECT_URL = "https://93eeb3ad.ngrok.io/api/v2/transactions/payment-status/"*/
