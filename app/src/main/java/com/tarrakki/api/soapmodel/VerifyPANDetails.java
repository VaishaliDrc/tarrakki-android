...
public class VerifyPANDetails {
    ...
    public static class RequestBody {
        ...
        //@Element(name = "VerifyPANDetails")
        @Element(name = "VerifyPANDetails_eKYC")
        private PANDetailsEKYC ekyc;

        public RequestBody() {
        }

        public static class PANDetailsEKYC {
            ...
            public PANDetailsEKYC setInput(APPREQROOTBean input) {
                this.input = input;
                return this;
            }
            */
            ...
            public PANDetailsEKYC setInput(InputXML input) {
                this.input = input;
                return this;
            }
            ...
            public PANDetailsEKYC setUserName(String userName) {
            ...
            public PANDetailsEKYC setPosCode(String posCode) {
                PosCode = posCode;
                return this;
            }
            ...
            public PANDetailsEKYC setPassword(String password) {
            ...
            public PANDetailsEKYC setPassKey(String passKey) {
        ...
        public PANDetailsEKYC getEkyc() {
            return ekyc;
        }

        public RequestBody setEkyc(PANDetailsEKYC ekyc) {
            this.ekyc = ekyc;
            return this;
        }
    }

    public VerifyPANDetails(RequestBody requestBody) {
        this.requestBody = requestBody;
    }

    public VerifyPANDetails() {
    }
    ...
    public VerifyPANDetails setRequestBody(RequestBody requestBody) {
        this.requestBody = requestBody;
        return this;
    }
